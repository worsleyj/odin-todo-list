...
const testItem = createNoteItem(
  ...
  "Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste accusantium " +
    ...
    "dolorum doloribus ducimus quia? Est, cumque illum.",
  "08/20/2024",
  "3",
  false
);
const testItemTwo = createNoteItem(
  "Note about Bread",
  "I freaking love bread man",
  "09/05/2024",
  "1",
  false
);
const testItemThree = createNoteItem(
  "Top 10 Animals",
  "Number 9: Cow",
  "01/01/2024",
  "2",
